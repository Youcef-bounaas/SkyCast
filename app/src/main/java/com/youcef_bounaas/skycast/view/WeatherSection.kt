package com.youcef_bounaas.skycast.view
...
import com.youcef_bounaas.skycast.constant.Const.Companion.LOADING
import com.youcef_bounaas.skycast.constant.Const.Companion.NA
import com.youcef_bounaas.skycast.model.weather.WeatherResult
import com.youcef_bounaas.skycast.utils.Utils.Companion.buildIcon
import com.youcef_bounaas.skycast.utils.Utils.Companion.timestampToHumanDate
...
fun WeatherSection(weatherResponse: WeatherResult) {
    ...
    WeatherTitleSelection(text = title, subText = subTitle, fontSize = 30.sp)
    WeatherImage(icon = icon)
    WeatherTitleSelection(text = temp, subText = description, fontSize = 60.sp )
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .padding(16.dp),
...
@Composable
fun WeatherTitleSelection(text: String, subText: String, fontSize: TextUnit) {
    Column (
